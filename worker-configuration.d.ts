/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 4f148cf1814bd807cdce64b7f64dad4f)
// Runtime types generated with workerd@1.20250424.0 2025-05-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		DISCORD_MIKO_KEY: string;
		DISCORD_MIKO_QUEUE: Queue;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RSS_FEED_URL" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_CHANNEL_ID" | "DISCORD_MIKO_KEY">> {}
}
